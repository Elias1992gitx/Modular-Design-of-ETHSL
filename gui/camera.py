...
class Camera:
    ...
    #
    #     # Convert the image to PhotoImage format directly without converting back to NumPy array
    #     imgtk = ImageTk.PhotoImage(image=img_pil)
    #
    #     # Configure the label with the new image directly without resetting the imgtk attribute
    #     self.label_camera_preview.configure(image=imgtk)
    #
    #     # Keep a reference to the image to prevent garbage collection
    #     self.label_camera_preview.imgtk = imgtk
...
#
# class Camera:
#     def __init__(self, cap, label_camera_preview, isCameraActive):
#         self.cap = cap
#         self.label_camera_preview = label_camera_preview
#         self.isCameraActive = isCameraActive
#         self.start_preview()
...
#     def start_preview(self):
#         font_color = (0, 255, 0)
#         font_path = 'assets/font/AbyssinicaSIL-Regular.ttf'
...
#                 self.label_camera_preview.configure(image=photo)
#                 self.label_camera_preview.image = photo
#
#                 if cv2.waitKey(10) & 0xFF == ord('q'):
#                     break
#
