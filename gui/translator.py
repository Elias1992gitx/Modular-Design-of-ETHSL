...
class Translator:
    ...
    def load_model(self):
        self.model = tf.keras.models.load_model('C:/Users/Elias/Desktop/virenv1/Greeting8c.h5')
        self.font = ImageFont.truetype('C:/Users/Elias/Desktop/virenv1/AbyssinicaSIL-Regular.ttf', 32)
...
# import threading
# from utils.mediapipe_utils import mediapipe_detection, draw_styled_landmarks
# from utils.gui_utils import create_button, configure_style
# import cv2
# import constants as const
...
#             create_button(self, const.stopCamera)
#             self.isCameraActive = True
#             Camera(self.cap, self.label_camera_preview, self.isCameraActive)
#         else:
#             self.progressbar.stop()
#             self.progressbar.place_forget()
#             print("Failed to open the camera.")
